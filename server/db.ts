...
export const sequelize = new Sequelize(
  process.env.DB_NAME || 'iroc_db',
  process.env.DB_USER || 'root',
  process.env.DB_PASSWORD || '',
  {
    host: isMySql ? (host || 'localhost') : undefined,
...
export const Employee = sequelize.define('Employee', {
  ...
  work_phone: { type: DataTypes.STRING },
  avatar_url: { type: DataTypes.STRING },
  gender: { type: DataTypes.STRING, allowNull: false },
  birth_date: { type: DataTypes.DATE, allowNull: false },
  nationality: { type: DataTypes.STRING, defaultValue: 'Cambodia' },
  ...
  marital_status: { type: DataTypes.STRING, defaultValue: 'single' },
  spouse_name: { type: DataTypes.STRING },
  spouse_occupation: { type: DataTypes.STRING },
  spouse_phone: { type: DataTypes.STRING },
  department_id: { type: DataTypes.STRING, allowNull: false },
  position_id: { type: DataTypes.STRING, allowNull: false },
  reporting_manager_id: { type: DataTypes.STRING },
  employment_type: { type: DataTypes.STRING, defaultValue: 'Full-Time' },
  join_date: { type: DataTypes.DATE, allowNull: false },
  probation_period_months: { type: DataTypes.INTEGER, defaultValue: 3 },
  work_location: { type: DataTypes.STRING, defaultValue: 'office' },
  street_address: { type: DataTypes.STRING },
  city: { type: DataTypes.STRING },
  state_province: { type: DataTypes.STRING },
  postal_code: { type: DataTypes.STRING },
  country: { type: DataTypes.STRING, defaultValue: 'Cambodia' },
  ...
  salary_type: { type: DataTypes.STRING, defaultValue: 'monthly' },
  ...
  terminated_at: { type: DataTypes.DATE },
  termination_reason: { type: DataTypes.STRING },
...
export const EmployeeOnboardingSession = sequelize.define('EmployeeOnboardingSession', {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
  employee_id: { type: DataTypes.STRING },
  session_data: { type: DataTypes.TEXT, allowNull: false },
...
export const EmployeeAllowance = sequelize.define('EmployeeAllowance', {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
  employee_id: { type: DataTypes.STRING, allowNull: false },
  allowance_name: { type: DataTypes.STRING, allowNull: false },
...
export const EmployeeDeduction = sequelize.define('EmployeeDeduction', {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
  employee_id: { type: DataTypes.STRING, allowNull: false },
  deduction_name: { type: DataTypes.STRING, allowNull: false },
  amount: { type: DataTypes.DECIMAL(12, 2), allowNull: false },
  is_recurring: { type: DataTypes.BOOLEAN, defaultValue: true },
  effective_from: { type: DataTypes.DATE, allowNull: false },
  effective_to: { type: DataTypes.DATE },
...
export const EmployeeDependent = sequelize.define('EmployeeDependent', {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
  employee_id: { type: DataTypes.STRING, allowNull: false },
  name: { type: DataTypes.STRING, allowNull: false },
  relationship: { type: DataTypes.STRING, allowNull: false },
  birth_date: { type: DataTypes.DATE },
  is_beneficiary: { type: DataTypes.BOOLEAN, defaultValue: false },
  created_at: { type: DataTypes.DATE, defaultValue: DataTypes.NOW },
}, {
  indexes: [
    { fields: ['employee_id'] }
...
export const EmployeeStatusHistory = sequelize.define('EmployeeStatusHistory', {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
  employee_id: { type: DataTypes.STRING, allowNull: false },
...
export const EmployeeIdSequence = sequelize.define('EmployeeIdSequence', {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
  prefix: { type: DataTypes.STRING, defaultValue: 'EMP' },
  current_number: { type: DataTypes.INTEGER, defaultValue: 0 },
  padding_length: { type: DataTypes.INTEGER, defaultValue: 5 },
  updated_at: { type: DataTypes.DATE, defaultValue: DataTypes.NOW },
});
...
export const AttendanceRecord = sequelize.define('AttendanceRecord', {
  ...
  locationIn: { type: DataTypes.JSON },
  locationOut: { type: DataTypes.JSON },
  workHours: { type: DataTypes.FLOAT },
}, {
  indexes: [
    { fields: ['userId', 'date'] },
    { fields: ['date'] }
...
export const Task = sequelize.define('Task', {
  ...
  dependencies: { type: DataTypes.JSON },
  subtasks: { type: DataTypes.JSON },
  comments: { type: DataTypes.JSON },
  timeEntries: { type: DataTypes.JSON },
}, {
  indexes: [
    { fields: ['projectId'] },
    { fields: ['assigneeId'] },
...
export const PayrollRun = sequelize.define('PayrollRun', {
  ...
  totalEmployees: { type: DataTypes.INTEGER, defaultValue: 0 },
  totalNetPay: { type: DataTypes.FLOAT, defaultValue: 0 },
  status: { type: DataTypes.STRING, defaultValue: 'DRAFT' },
  processedBy: { type: DataTypes.STRING },
  createdAt: { type: DataTypes.STRING },
}, {
  indexes: [
    { fields: ['month'] },
...
export const Payslip = sequelize.define('Payslip', {
  id: { type: DataTypes.STRING, primaryKey: true },
  payrollRunId: { type: DataTypes.STRING, allowNull: false },
  userId: { type: DataTypes.STRING, allowNull: false },
  month: { type: DataTypes.STRING, allowNull: false },
  breakdown: { type: DataTypes.JSON },
  status: { type: DataTypes.STRING, defaultValue: 'DRAFT' },
  generatedAt: { type: DataTypes.STRING },
}, {
  indexes: [
    { fields: ['payrollRunId'] },
    { fields: ['userId', 'month'] }
...
export const Job = sequelize.define('Job', {
  ...
  salaryRange: { type: DataTypes.STRING },
}, {
  indexes: [
    { fields: ['departmentId'] },
    { fields: ['status'] }
...
export const RolePermission = sequelize.define('RolePermission', {
  ...
  actions: { type: DataTypes.JSON, defaultValue: ['view'] },
}, {
  indexes: [
...
export const UserPermissionOverride = sequelize.define('UserPermissionOverride', {
  id: { type: DataTypes.STRING, primaryKey: true },
  userId: { type: DataTypes.STRING, allowNull: false },
  permissionId: { type: DataTypes.STRING, allowNull: false },
  overrideType: { type: DataTypes.ENUM('GRANT', 'REVOKE'), allowNull: false },
  grantedBy: { type: DataTypes.STRING },
  reason: { type: DataTypes.TEXT },
  expiresAt: { type: DataTypes.DATE },
  requiresApproval: { type: DataTypes.BOOLEAN, defaultValue: false },
  status: { type: DataTypes.ENUM('ACTIVE', 'PENDING', 'EXPIRED', 'REVOKED'), defaultValue: 'PENDING' },
...
export const PermissionOverrideRequest = sequelize.define('PermissionOverrideRequest', {
  id: { type: DataTypes.STRING, primaryKey: true },
  userId: { type: DataTypes.STRING, allowNull: false },
  permissionId: { type: DataTypes.STRING, allowNull: false },
  overrideType: { type: DataTypes.ENUM('GRANT', 'REVOKE'), allowNull: false },
...
export const DepartmentSetting = sequelize.define('DepartmentSetting', {
  id: { type: DataTypes.STRING, primaryKey: true },
...
export const PositionSetting = sequelize.define('PositionSetting', {
  id: { type: DataTypes.STRING, primaryKey: true },
...
export const EmployeeSetting = sequelize.define('EmployeeSetting', {
  id: { type: DataTypes.STRING, primaryKey: true },
...
export const PermissionTemplate = sequelize.define('PermissionTemplate', {
  id: { type: DataTypes.STRING, primaryKey: true },
  name: { type: DataTypes.STRING, allowNull: false },
  description: { type: DataTypes.TEXT },
...
export const SettingAuditLog = sequelize.define('SettingAuditLog', {
  id: { type: DataTypes.STRING, primaryKey: true },
  settingKey: { type: DataTypes.STRING, allowNull: false },
  settingLevel: { type: DataTypes.ENUM('global', 'department', 'position', 'employee'), allowNull: false },
  levelId: { type: DataTypes.STRING }, // departmentId, positionId, or employeeId
  oldValue: { type: DataTypes.JSON },
  newValue: { type: DataTypes.JSON },
...
export const initDb = async () => {
  try {
    ...
    if (userCount === 0) {
      ...
      await Payslip.bulkCreate(payslips);
      ...
      await PermissionTemplate.bulkCreate(templates);
...
Department.belongsTo(Employee, { foreignKey: 'department_head_id', as: 'head' });
...
EmployeeOnboardingSession.belongsTo(Employee, { foreignKey: 'employee_id', as: 'employee' });
...
EmployeeDependent.belongsTo(Employee, { foreignKey: 'employee_id', as: 'employee' });
EmployeeDocument.belongsTo(Employee, { foreignKey: 'employee_id', as: 'employee' });

// Employee status history
EmployeeStatusHistory.belongsTo(Employee, { foreignKey: 'employee_id', as: 'employee' });

// ============================================
// SEQUELIZE ASSOCIATIONS - RBAC & SETTINGS MODULE
// ============================================

// Role/Permission matrix links
...
// User permission override links
...
Permission.hasMany(UserPermissionOverride, { foreignKey: 'permissionId', as: 'userOverrides' });
UserPermissionOverride.belongsTo(Permission, { foreignKey: 'permissionId', as: 'permission' });
UserPermissionOverride.belongsTo(User, { foreignKey: 'grantedBy', as: 'grantedByUser', constraints: false });

// Permission request approval workflow links
PermissionOverrideRequest.belongsTo(User, { foreignKey: 'userId', as: 'user' });
PermissionOverrideRequest.belongsTo(Permission, { foreignKey: 'permissionId', as: 'permission' });
PermissionOverrideRequest.belongsTo(User, { foreignKey: 'requestedBy', as: 'requestedByUser', constraints: false });
PermissionOverrideRequest.belongsTo(User, { foreignKey: 'reviewedBy', as: 'reviewedByUser', constraints: false });

// Settings hierarchy links
Department.hasMany(DepartmentSetting, { foreignKey: 'departmentId', as: 'settings' });
DepartmentSetting.belongsTo(Department, { foreignKey: 'departmentId', as: 'department' });
Position.hasMany(PositionSetting, { foreignKey: 'positionId', as: 'settings' });
PositionSetting.belongsTo(Position, { foreignKey: 'positionId', as: 'position' });
User.hasMany(EmployeeSetting, { foreignKey: 'employeeId', as: 'settings' });
EmployeeSetting.belongsTo(User, { foreignKey: 'employeeId', as: 'employee' });
SystemSetting.hasMany(DepartmentSetting, { foreignKey: 'settingKey', sourceKey: 'key', as: 'departmentOverrides', constraints: false });
DepartmentSetting.belongsTo(SystemSetting, { foreignKey: 'settingKey', targetKey: 'key', as: 'baseSetting', constraints: false });
SystemSetting.hasMany(PositionSetting, { foreignKey: 'settingKey', sourceKey: 'key', as: 'positionOverrides', constraints: false });
PositionSetting.belongsTo(SystemSetting, { foreignKey: 'settingKey', targetKey: 'key', as: 'baseSetting', constraints: false });
SystemSetting.hasMany(EmployeeSetting, { foreignKey: 'settingKey', sourceKey: 'key', as: 'employeeOverrides', constraints: false });
EmployeeSetting.belongsTo(SystemSetting, { foreignKey: 'settingKey', targetKey: 'key', as: 'baseSetting', constraints: false });

// Audit links
AuditLog.belongsTo(User, { foreignKey: 'performedBy', as: 'performedByUser', constraints: false });
SettingAuditLog.belongsTo(User, { foreignKey: 'changedBy', as: 'changedByUser', constraints: false });
